            ...
            <Card className="bg-gradient-to-r from-primary-50 to-secondary-50 border border-primary-200">
              <CardBody className="gap-2">
                ...
                <ul className="text-sm text-default-600 space-y-1">
                  <li>• <strong>Shared key:</strong> 50 responses per day limit (shared among all users)</li>
                  <li>• <strong>Your key:</strong> Your own usage limits and better reliability</li>
                  <li>• <strong>Cost:</strong> Very affordable - most models cost fractions of a penny</li>
                </ul>
              </CardBody>
            </Card>
            ...
            <Card className="bg-warning-50 border border-warning-200">
              <CardBody className="gap-2">
                ...
                <p className="text-sm text-warning-700">
                  Your API key is stored locally in your browser and sent securely to OpenRouter. 
